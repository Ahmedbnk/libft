...
/*   Updated: 2024/11/02 16:03:15 by abenkrar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

size_t	count_length(int n)
{
	size_t	length;
...
char	*reverse_string(char *str, int sign)
{
	char	*str_clone;
	size_t	start;
	size_t	end;
...
void	norminette_26line(char *string, int n, size_t n_length)
{
	size_t	i;
	int		sign;
